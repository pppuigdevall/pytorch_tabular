...
class BoostedFTTransformerBackbone(pl.LightningModule):
    ...
    def _build_network(self):
        # This stays the same because is the embedding part for categorical variables
        ...
        # This also stays the same because it is the embedding part for cont variables
...
class BoostedFTTransformerModel(BaseModel):
